...
final class FormHTML {
	...
	{
		return self::input('text', $field, $value, $attributes);
	}
	...
	{
		return self::input('number', $field, $value, $attributes);
	}
	...
	{
		return self::input('hidden', $field, $value, $attributes);
	}
	...
	{
		return self::input('file', $field, NULL, $attributes);
	}
	
	/**
	 * Retourne une balise input submit
	 * @param string $textstatic
	 * @param array $attributes
	 * @return string
	 */
	public static function submit(?string $text, array $attributes = []) : string
	{
		return self::input('submit', NULL, $text, $attributes);
	}
