<form method="post">
    ...
    <x-form-input 
        ...
        input-name="nickname"
        :required="true" 
        :label="trans('form.user.fields.nickname')"
    >
        <x-slot name="input">
    ...
    <x-form-input 
        ...
        input-name="email"
        :required="true" 
        :label="trans('form.user.fields.email')"
    >
        <x-slot name="input">
    ...
    <x-form-input 
        ...
        :label="trans('form.user.fields.current_password')"
    >
        <x-slot name="input">
    ...
    <x-form-input 
        ...
        :label="trans('form.user.fields.new_password')"
    >
        <x-slot name="input">
    ...
    <x-form-input 
        ...
        :label="trans('form.user.fields.new_password_confirmation')"
    >
        <x-slot name="input">
